...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('redeemsetting/index')));
		?>
        <?php
        echo TbHtml::button('<span class="fa  fa-cube"></span> '.Yii::t('redeem','Save'), array(
            'submit'=>Yii::app()->createUrl('redeemsetting/save')));
        ?>
        <?php echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('redeem','Delete'), array( 'submit'=>Yii::app()->createUrl('redeemsetting/delete'))
        );
        ?>
	</div>
