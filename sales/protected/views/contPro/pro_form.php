...
<?php $this->renderPartial('//contPro/pro_form_F',array("model"=>$model,"form"=>$form)); ?>
...
EOF;
    ...
    if($model->pro_type!="C"){
        ...
        $minDate=date("Y/m/d",strtotime("{$model->contHeadRow["cont_end_dt"]} + 1 day"));
        $js.="$('#pro_date,#cont_end_dt').datepicker({startDate: '{$minDate}',autoclose: true,language: 'zh_cn', format: 'yyyy/mm/dd'});";
    }
