    ...
    <div class="box"><div class="box-body">
            <div class="btn-group" role="group">
                <?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
                    'submit'=>Yii::app()->createUrl('marketSales/index')));
                ?>
                <?php if ($model->scenario!='view'&&in_array($model->status_type,array(5,6))): ?>
                    <?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
                        'submit'=>Yii::app()->createUrl('marketSales/save')));
                    ?>
                <?php endif ?>
                <?php if ($model->scenario=='edit'&&in_array($model->status_type,array(5,6))): ?>
...
$js = "
$('table').on('change','[id^=\"MarketSalesForm\"]',function() {
	var n=$(this).attr('id').split('_');
	$('#MarketSalesForm_'+n[1]+'_'+n[2]+'_uflag').val('Y');
});
";
...
$('.btnAddRow').on('click',function() {
	...
	if (r>0) {
		...
		table.find('tr').eq(-1).find('[id*=\"MarketSalesForm_\"]').each(function(index) {
			var id = $(this).attr('id');
...
$this->renderPartial('//marketForm/backDialog',array(
    'submit'=>Yii::app()->createUrl('marketSales/back'),
    'type_num'=>1,
    'jsHtml'=>""
));
?>
...
$this->renderPartial('//marketForm/rejectDialog',array(
    'submit'=>Yii::app()->createUrl('marketSales/reject'),
    'type_num'=>1,
    'jsHtml'=>""
));
?>
...
$this->renderPartial('//marketForm/successDialog',array(
    'submit'=>Yii::app()->createUrl('marketSales/success'),
    'type_num'=>1,
    'jsHtml'=>""
));
?>