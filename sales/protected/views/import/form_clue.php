...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Import'); ?></strong>
	</h1>
</section>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php 
			echo TbHtml::button(Yii::t('misc','Submit'), array('submit'=>Yii::app()->createUrl('import/clueSubmit')));
		?>
	</div>
	</div></div>
	...
	<div class="box box-info">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<?php echo $form->dropDownList($model, 'import_type', $model->getClueImportTypeList(),array("id"=>"import_type")); ?>
			</div>
            <div class="col-sm-7">
