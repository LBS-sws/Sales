<tr class='clickable-row' data-href='<?php echo $this->getLink('CMT02', 'clientHead/edit', 'clientHead/view', array('index'=>$this->record['id']));?>'>
	<td><?php echo $this->drawEditButton('CMT02', 'clientHead/edit', 'clientHead/view', array('index'=>$this->record['id'])); ?></td>
