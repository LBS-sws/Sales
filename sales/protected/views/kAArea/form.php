...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','KA Area'); ?></strong>
	</h1>
</section>
		...
		<?php 
			if ($model->scenario!='new' && $model->scenario!='view') {
				echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add Another'), array(
					'submit'=>Yii::app()->createUrl('kAArea/new')));
			}
		?>
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('kAArea/index'))); 
		?>
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('kAArea/save'))); 
			?>
<?php endif ?>
...
<?php endif ?>
	...
	<div class="box box-info">
		<div class="box-body">
			...
			<div class="form-group">
				<?php echo $form->labelEx($model,'city_code',array('class'=>"col-sm-2 control-label")); ?>
				<div class="col-sm-3">
...
<?php
$js = Script::genDeleteData(Yii::app()->createUrl('kAArea/delete'));
