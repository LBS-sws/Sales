...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','KA Reject'); ?></strong>
	</h1>
</section>
		...
		<?php 
			if ($model->scenario!='new' && $model->scenario!='view') {
				echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add Another'), array(
					'submit'=>Yii::app()->createUrl('kAType/new')));
			}
		?>
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('kAType/index'))); 
		?>
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('kAType/save'))); 
			?>
<?php endif ?>
	...
	<div class="box box-info">
		<div class="box-body">
			...
			<div class="form-group">
				<?php echo $form->labelEx($model,'ka_name',array('class'=>"col-sm-2 control-label")); ?>
				<div class="col-sm-5">
					<?php echo $form->textField($model, 'ka_name',
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<?php echo $form->dropDownList($model, 'ka_type',KATypeForm::getTypeList(),
...
<?php
$js = Script::genDeleteData(Yii::app()->createUrl('kAType/delete'));
