<tr class='clickable-row <?php echo $this->record['textColor'];?>' data-href='<?php echo $this->getLink('SC02', 'stopBack/edit', 'stopBack/view', array('index'=>$this->record['service_id']));?>'>
    <td><?php echo $this->drawEditButton('SC02', 'stopBack/edit', 'stopBack/view', array('index'=>$this->record['service_id'])); ?></td>
    <td>
        <?php
