...
class RedeemsettingController extends Controller
{
    public $function_id='HC08';
    ...
    public function accessRules()
    {
        return array(
            array('allow',
                ...
                'expression'=>array('RedeemsettingController','allowReadWrite'),
            ),
            array('allow',
                'actions'=>array('index','view'),
                'expression'=>array('RedeemsettingController','allowReadOnly'),
            ),
    ...
    public function actionSave()
    {
        ...
        if ($result) {
            ...
            $this->redirect(Yii::app()->createUrl('redeemsetting/edit',array('index'=>$id)));
        } else {
    ...
    public static function allowReadWrite() {
        return Yii::app()->user->validRWFunction('HC08');
    }

    public static function allowReadOnly() {
        return Yii::app()->user->validFunction('HC08');
    }
}
