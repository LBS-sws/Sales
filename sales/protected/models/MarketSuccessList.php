...
class MarketSuccessList extends CListPageModel
{
    public $employee_id;
	...
	public function retrieveDataByPage($pageNum=1)
	{
        ...
        $whereSql = " and a.status_type=10";
		$sql1 = "select a.id,a.ready_bool,a.number_no,a.z_index,a.person_phone,a.company_name,a.allot_type,a.allot_city,a.allot_employee,
		...
		$session['marketSuccess_c01'] = $this->getCriteria();
		return true;
	}
    ...
    public function countNotify(){
        ...
        $row = Yii::app()->db->createCommand()
            ->select("count(a.id)")
            ->from("sal_market a")
            ->where("a.status_type=10 and a.ready_bool=0")->queryScalar();
        return $row;
    }
}
