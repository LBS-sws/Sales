...
class CABotList extends KABotList {
    ...
    public function retrieveDataByPage($pageNum=1)
    {
        ...
        if (count($records) > 0) {
            foreach ($records as $k=>$record) {
                ...
                $sql = "select info_date,info_text from sal_ca_bot_info where bot_id=".$record['id']." order by info_date desc";
        ...
        $session['cABot_c01'] = $this->getCriteria();
        return true;
    }
}
