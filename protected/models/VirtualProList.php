...
class VirtualProList extends CListPageModel
{
    public $flow_odds="";
    /**
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'total_amt'=>Yii::t('clue','invoice amt'),//预估成交金额
    ...
    public function searchColumns() {
        ...
        $search = array(
            'pro_code'=>"cont.pro_code",
            'pro_type'=>"cont.pro_type",
            'pro_date'=>"cont.pro_date",
            'clue_id'=>"cont.clue_id",
            'cont_code'=>"cont.cont_code",
            'cust_name'=>"a.cust_name",
            'yewudalei'=>"cont.yewudalei",
    ...
    {
        $suffix = Yii::app()->params['envSuffix'];
        $sql1 = "select cont.*,h.name as lbs_main_name ,
        ...
        $session['criteria_VirtualProList'] = $this->getCriteria();
        return true;
    }
