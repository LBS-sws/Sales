<tr>
	...
	<th width="100px">
		<?php echo TbHtml::link($this->getLabelName('last_date').$this->drawOrderArrow('a.last_date'),'#',$this->createOrderLink('code-list','a.last_date'))
			;
		?>
	</th>
	<th width="130px">
		<?php echo TbHtml::link($this->getLabelName('clue_status').$this->drawOrderArrow('a.clue_status'),'#',$this->createOrderLink('code-list','a.clue_status'))
			;
		?>
	</th>
	<th width="130px">
		<?php echo TbHtml::link($this->getLabelName('rec_employee_id').$this->drawOrderArrow('a.rec_employee_id'),'#',$this->createOrderLink('code-list','a.rec_employee_id'))
			;
		?>
	</th>
    <th width="100px"><?php echo TbHtml::link(Yii::t("clue","clue service store"),"#");?></th>
</tr>
