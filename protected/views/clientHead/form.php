...
<section class="content">
	...
	<div class="btn-group" role="group">
        ...
        if($model->scenario=="new"){
            $backUrl = Yii::app()->createUrl('clientHead/index');
        }else{
            $backUrl = Yii::app()->createUrl('clientHead/view',array("index"=>$model->id));
        }
...
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('clientHead/save'))); 
			?>
<?php endif ?>
...
<?php endif ?>
            ...
            <?php if ($model->scenario!='new'): ?>
                <div class="btn-group pull-right" role="group">
                    <?php echo TbHtml::button('<span class="fa fa-list"></span> '.Yii::t('clue','Client History'), array(
...
<?php
$js = Script::genDeleteData(Yii::app()->createUrl('clientHead/delete'));
...
$this->renderPartial('//clue/select_clue',array("actionUrl"=>Yii::app()->createUrl('clientHead/new')));
?>
