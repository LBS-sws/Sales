...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php 
			if (Yii::app()->user->validRWFunction('CA01'))
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="btn-group" role="group">
                    ...
                    $signList=CABotForm::getSignOddsListForId();
                    $signList[""]="全部";
                    $signZero = $signList[0];
                    unset($signList[0]);
                    $signList[0]=$signZero;
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        ...
        'model'=>$model,
        'viewhdr'=>'//cABot/_listhdr',
        'viewdtl'=>'//cABot/_listdtl',
        'search'=>array(
            'customer_no',
            'customer_name',
            'available_date',
...
$ftrbtn[] = TbHtml::button(Yii::t('ka','Download'), array(
    ...
    'submit'=>Yii::app()->createUrl('cABot/downExcel')
));
...
<?php $this->endWidget(); ?>
<?php
$url = Yii::app()->createUrl('cABot/index',array("pageNum"=>1));
$js = <<<EOF
...
$('.click-td').on('click',function(e){
    ...
    $('.btn_submit').on('click',function(){
        ...
        $("#CABotList_orderField").val("");
        $("#CABotList_sign_odds").val(key);
