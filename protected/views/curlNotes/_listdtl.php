...
<tr>
	...
	<td class="text-break" data-id="<?php echo $this->record['id']; ?>" data-type="2" style="word-break: break-all;"><?php echo $this->record['info_url']; ?></td>
	...
	<td>
        <?php
        $url = Yii::app()->createUrl('curlNotes/resetSendData',array("index"=>$this->record['id']));
