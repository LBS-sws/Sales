...
<section class="content">
            ...
            <div class="btn-group" role="group">
                ...
                if (Yii::app()->user->validRWFunction('MT04')){
                    echo TbHtml::button('<span class="fa fa-flag"></span> '.Yii::t('market','ready all'), array(
                            'data-toggle'=>'modal','submit'=>Yii::app()->createUrl('marketReject/readyAll'))
                    );
                }
                ?>
            </div>
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('app','Market Reject'),
        'model'=>$model,
        'viewhdr'=>'//marketReject/_listhdr',
        'viewdtl'=>'//marketReject/_listdtl',
        'search'=>array(
            'number_no',
            'company_name',
            'person_phone',
...
<?php $this->endWidget(); ?>
<?php
$url = Yii::app()->createUrl('marketReject/index',array("pageNum"=>1));
$js = <<<EOF
