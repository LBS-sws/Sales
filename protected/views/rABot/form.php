...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','RA Bot'); ?></strong>
	</h1>
</section>
		...
		<?php 
			if ($model->scenario!='new' && $model->scenario!='view') {
				echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add Another'), array(
					'submit'=>Yii::app()->createUrl('rABot/new')));
			}
		?>
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('rABot/index')));
		?>
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('rABot/save')));
			?>
<?php endif ?>
                    ...
                    */
                    ...
                    if($model->employee_id==$model->kam_id){
                        echo TbHtml::button('<span class="glyphicon glyphicon-pencil"></span> '."编辑", array(
                            'submit'=>Yii::app()->createUrl('rABot/edit',array("index"=>$model->id))));
                    }
                    ?>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            $this->widget('ext.layout.TableView2Widget', array(
                                ...
                                'attribute'=>'avaInfo',
                                'expr_id'=>'ava',
                                'viewhdr'=>'//rABot/_ava_hdr',
                                'viewdtl'=>'//rABot/_ava_dtl',
                            ));
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="row">
                            ...
                            $this->widget('ext.layout.TableView2Widget', array(
                                ...
                                'attribute'=>'detail',
                                'expr_id'=>'info',
                                'viewhdr'=>'//rABot/_formhdr',
                                'viewdtl'=>'//rABot/_formdtl',
                            ));
                            ?>
                        </div>
                    </div>
...
$('table').on('change','[id^=\"RABotForm\"]',function() {
	...
	$('#RABotForm_'+n[1]+'_'+n[2]+'_uflag').val('Y');
});
...
$ajaxUrl=Yii::app()->createUrl('rABot/ajaxSupportUser');
$link3=Yii::app()->createUrl('rABot/ajaxCustomerName');
$js ="
...
function changeCustomerName(){
	...
	var data = \"group=\"+$(this).val()+\"&id=\"+$('#RABotForm_id').val();
	$.ajax({
		type: 'GET',
		url: '$link3',
		data: data,
...
$js = Script::genDeleteData(Yii::app()->createUrl('rABot/delete'));
...
$('.btnAddRow').on('click',function() {
	...
	if (r>0) {
		...
		$('#tblDetail'+expr_id+' tbody>tr').eq(0).find('[id*=\"RABotForm_\"]').each(function(index) {
			var id = $(this).attr('id');
