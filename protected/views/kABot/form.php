...
<section class="content">
                    ...
                    */
                    ...
                    if($model->employee_id==$model->kam_id){
                        echo TbHtml::button('<span class="glyphicon glyphicon-pencil"></span> '."编辑", array(
                            'submit'=>Yii::app()->createUrl('kABot/edit',array("index"=>$model->id))));
                    }
                    ?>
    ...
    <div class="box box-info">
        <div class="box-body">
            ...
            <?php echo CHtml::hiddenField('dtltemplate_renewal'); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2">
                    <?php echo $form->textField($model, 'available_date',
                        array('readonly'=>($model->scenario=='view'),'id'=>'available_date','autocomplete'=>'off','prepend'=>'<span class="fa fa-calendar"></span>')
                    ); ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2">
                    <?php echo $form->textField($model, 'sign_date',
                        array('readonly'=>($model->scenario=='view'),'id'=>'sign_date','autocomplete'=>'off','prepend'=>'<span class="fa fa-calendar"></span>')
                    ); ?>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            $this->widget('ext.layout.TableView2Widget', array(
                                ...
                                'expr_id'=>'renewal',
                                'viewhdr'=>'//kABot/_renewal_hdr',
                                'viewdtl'=>'//kABot/_renewal_dtl',
                            ));
                            ?>
                        </div>
                    </div>
...
<?php $this->renderPartial('//kABot/shiftDialog',array("model"=>$model,"submit"=>Yii::app()->createUrl('kABot/shift'))); ?>
<?php
